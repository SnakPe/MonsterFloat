...
class MonsterFloat{
   ...
   */
	...
	private orderOperationHelper(op : (left : bigint, right : bigint) => boolean) : ((other : Numeric) => boolean){
		return (other) => {
			other = MonsterFloat.from(other)
	 ...
	 */
	public isLessThan(other : Numeric){
		return this.orderOperationHelper((l,r) => l < r)(other) 
	}
	/**
	 ...
	 * console.log(num1.isLessThan(num2)); // true
	 */
	public isLessThanOrEqual(other : Numeric){
		return this.orderOperationHelper((l,r) => l <= r)(other) 
	}
	/**
	 * Compares this number with another numeric value to determine if this number is less than or equal to the other.
	 ...
	 * console.log(num1.isLessThan(num2)); // true
	 */
	public isGreaterThan(other : Numeric){
		return this.orderOperationHelper((l,r) => l > r)(other) 
	}
	/**
	 ...
	 * console.log(num1.isLessThan(num2)); // true
	 */
	public isGreaterThanOrEqual(other : Numeric){
		return this.orderOperationHelper((l,r) => l >= r)(other) 
	}
}
